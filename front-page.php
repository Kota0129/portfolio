...
<main id="main" class="main" role="main">
  <section class="hero" role="region" aria-labelledby="hero-title">
    <picture aria-hidden="true">
      ...
      <!-- PC用画像-->
      <img src="<?php echo get_template_directory_uri(); ?>/img/hero_visual-pc.png" alt="" class="hero__bg-image" role="presentation">
    </picture>

    <div class="hero__inner">
      <div class="hero__text">
        <p class="hero__role">Webコーダー / WordPress対応</p>
        <h1 id="hero-title" class="hero__catch-wrap">
...
<main id="main" class="main">
  <section class="hero">
    <picture>
      ...
      <source media="(max-width: 767px)" srcset="<?php echo get_template_directory_uri(); ?>/img/hero_visual-sp.png">
      <!-- PC用画像 -->
      <img src="<?php echo get_template_directory_uri(); ?>/img/hero_visual-pc.png" alt="ヒーロービジュアル" class="hero__bg-image">
    </picture>
    <div class="hero__inner">
      <div class="hero__text">
        <p class="hero__role">Webコーダー / WordPress対応</p>
        <h1 class="hero__catch-wrap">
          <span class="hero__catch-line">“ちゃんと伝わる”を大切に。</span>
          <span class="hero__catch-line">誠実対応で安心のWeb制作を。</span>
        </h1>
>>>>>>> 7a5becf (はじめてのアップ)
...
=======
        <a href="<?php echo esc_url(get_permalink(get_page_by_path('contact'))); ?>" class="contact__btn">
          ご相談はこちら <span class="contact__btn-arrow">▶︎</span>
        </a>
        <a href="<?php echo esc_url(get_permalink(get_page_by_path('services'))); ?>#price" class="price__link-subtle">
          料金の目安も見る
          <img src="<?php echo get_template_directory_uri(); ?>/img/price_arrow.png" alt="料金の目安も見るの案内アイコン" class="price__arrow">
>>>>>>> 7a5becf (はじめてのアップ)
        </a>
      </div>
    </div>
...
=======
  <section class="portfolio fadein" id="portfolio">
    <div class="section-inner">
      ...
      <div class="portfolio__grid">
        <?php
        $post = get_page_by_path('maripro', OBJECT, 'works');
        if ($post) :
        ?>
          <a href="<?php echo esc_url(get_permalink($post->ID)); ?>" class="portfolio__item">
            <figure>
              <img src="<?php echo esc_url(get_theme_file_uri('img/portforio1.png')); ?>" alt="Marriage Project">
              <figcaption>
                <p class="portfolio__title">Marriage Project様_HP</p>
                <ul class="portfolio__tags">
                  <li>デザイン支給</li>
    ...
    <a href="<?php echo esc_url(get_permalink(get_page_by_path('portfolio'))); ?>" class="btn">
      制作一覧を見る <span class="btn__arrow">▶︎</span>
    </a>
  </section>

  <section class="services fadein" id="services">
    <div class="section-inner">
      <h2 class="section-title">
        <span class="ja">サービス内容</span>
        <span class="divider"></span>
...
=======
      <a href="<?php echo esc_url(get_permalink(get_page_by_path('services'))); ?>" class="btn">
        サービス内容を見る <span class="btn__arrow">▶︎</span>
>>>>>>> 7a5becf (はじめてのアップ)
      </a>
    </div>
  </section>
...
=======
  <section class="about fadein" id="about">
    <div class="section-inner">
      <h2 class="section-title">
        <span class="ja">Kota_WebOfficeについて</span>
        <span class="divider"></span>
...
=======
            <li><span class="about__icon about__icon--hand">&lt;/&gt;</span> デザインはできたけど、コーディングは任せたい</li>
            <li><span class="about__icon about__icon--hand">&lt;/&gt;</span> スマホでも見やすいレイアウトにしてほしい</li>
            <li><span class="about__icon about__icon--hand">&lt;/&gt;</span> WordPressで更新しやすいサイトにしたい</li>
          </ul>
          <a href="<?php echo esc_url(get_permalink(get_page_by_path('profile'))); ?>" class="btn">
            詳しく知る <span class="btn__arrow">▶︎</span>
          </a>
        </div>
        <div class="about__image">
          <img src="<?php echo esc_url(get_theme_file_uri('img/about-image.png')); ?>" alt="Web制作のイメージ">
>>>>>>> 7a5becf (はじめてのアップ)
        </div>
      </div>
    </div>
...
=======
  <section class="flow fadein" id="flow">
    <div class="section-inner wrapper">
      <h2 class="section-title">
        <span class="ja">制作の流れ</span>
        <span class="divider"></span>
...
=======
  <section class="faq fadein" id="faq">
    <div class="section-inner">
      <h2 class="section-title">
        <span class="ja">よくある質問</span>
        <span class="divider"></span>
      ...
      <div class="ac-menu">
        <div class="faq-item">
          <div class="label">Q. 納期はどれくらいですか？</div>
          <div class="answer">
            A. 内容にもよりますが、目安として2週間〜1ヶ月程度となります。お急ぎの場合もご相談ください。
          </div>
        </div>
        <div class="faq-item">
          <div class="label">Q. 対応エリアはどこですか？</div>
          <div class="answer">
            A. 全国対応しております。基本的にオンラインでやり取り可能ですので、遠方のお客様もご安心ください。
          </div>
        </div>
        <div class="faq-item">
          <div class="label">Q. 納品後のサポートはありますか？</div>
          <div class="answer">
>>>>>>> 7a5becf (はじめてのアップ)
    ...
    <div class="section-inner">
      ...
      <a href="<?php echo esc_url(get_permalink(get_page_by_path('contact'))); ?>" class="contact__btn" aria-label="お問い合わせフォームへ移動">
        <span class="contact__btn-icon" aria-hidden="true">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" focusable="false">
=======
    <a href="<?php echo esc_url(get_permalink(get_page_by_path('services')) . '#faq'); ?>" class="btn">他の質問も見る</a>
  </section>
...
<<<<<<< HEAD
  <!-- ========== NEWS ========== -->
  <section class="news" id="news" role="region" aria-labelledby="news-title">
    <div class="section-inner">
